import{a as s}from"./api-e87358eb.js";const n=()=>Math.round(Math.random()*1561),u=async()=>{let e=[];for(let t=0;t<5;t+=1){const r=await s.getCharacters({limit:1,offset:n()});e.push(r[0])}return console.log(e),i(e)};function i(e){const t=e.map(({thumbnail:r,name:a,description:l})=>`  <li class='rc-item'>
      <img
